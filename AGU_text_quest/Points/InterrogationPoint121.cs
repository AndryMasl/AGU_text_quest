...
namespace Points
{
    ...
    {
        public override string Content => $"{Player.Name} глянул на охраника. 'Привет! Помнишь меня? В кс гамали вместе' - Сказал {Player.Instance.Name}. 'Погодь. {Player.Instance.Name} , не узнал меня? Это же я Макс Суков'- ответил Макс Суков . 'Почему ты охранник? Ты же в инсте учился' - спросил {Player.Instance.Name}. 'О это долгая история' - Сказал Макс Суков" ;
