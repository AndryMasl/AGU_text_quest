...
namespace Points
{
	...
	internal class SecondActionTutaevsBasement : SecondAction
	{
        ...
        {
            IsAvailable = false;
            MassageAfterAction = $"Опа) Юнис бежит к матису, открывает дверь, а внутри салона все просто от новой крутой бехи. Юнис завел тачку, нажал на газ и стрелка спидометра показала сразу 8000000 км/ч , Юнис не справился с управлением и въехал в зеленый магазинчик на углу и снес его. Юнис вылез из тачки и вернулся обратно на локацию.";
        }
    }
