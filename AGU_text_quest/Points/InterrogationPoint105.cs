...
namespace Points
{
    ...
    {
        public override string Content => $"{Player.Name} разогнался и прыгнул в секретное место. Там {Player.Instance.Name} увидел много тренажеров и на одном из них тягал жим лежа какой-то сверх Гиго Мега качок, издалека похож на Сарычева или Маланичева. Подойдя ближе, {Player.Name} увидел чела, который говорил : 'Бред бред бред бред'.\n" +
