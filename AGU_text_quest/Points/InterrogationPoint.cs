...
namespace Points
{
	...
	{
		public override string Content => $"Дверь за спиной захлопнулась и закрылась на 10 замков. В комнате нет мебели, кроме стола и стула посередине. Помимо {Player.Name}а в комнате были еще двое, слева от стола - Майор Либовски, справа - Капитан Никитин. Кто из них хороший, а кто плохой полицейский еще предстояло узнать. Либовски жестом пригласил {Player.Name}а присесть за стол.";
