...
namespace Points
{
	...
	{
		public override string Content => $"Дверь за спиной захлопнулась и закрылась на 10 замков. В комнате нет мебели, кроме стола и стула посередине. Помимо {Player.Name} в комнате были еще двое, слева от стола - Майор Либовски, справа - Капитан Никитин. Кто из них хороший, а кто плохой полицейский еще предстояло узнать. Либовски жестом пригласил {Player.Name}а присесть за стол.";
		...
		private void DoBeforeActionLocal()
		{
			...
			Console.WriteLine("Сквозь закрытую дверь, словно призрак, входит СильверГрэг. \"Так, так, ебаная комната для допросов. Ну ты попал, дружок. Глянь на того справа, выкрасил волосы в белый, и проколол себе всю морду, явно тащится от РаймШтайн. Ну и долбан, на него можешь не обращать внимание, важен тут левый, постарайся с ним поспокойнее.\"\n");
		}
	}
