...
namespace Points
{
	...
	{
		public override string Content => $"{Player.Instance.Name} почесал затылок: Ох уж это Компеко Плазо.";
