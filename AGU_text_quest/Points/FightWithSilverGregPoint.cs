...
namespace Points
{
	...
	internal class SecondActionFightWithSilverGregPoint : SecondAction
	{
        ...
        {
			IsAvailable = false;
			MassageAfterAction = $"СильверГрэг: Нет, он гений кулинарии.\nВ процессе борьбы {Player.Instance.Name}а кидает по всему салону автобуса. Посажирские сидения не выдерживают и ломаются одно за другим. Офигевший водитель выпрыгивает из автобуса.\n";
        }
	}
