...
namespace Points
{
    ...
    {
        public override string Content => $"Макс Суков рассказывает, что раньше , еще давно во времена школы и начала учебы в инсте он до сих пор общался с предыдущим охранником. Они гамали в кс , вечелились , бегалди в парке. Но в один день, когда они плотнячком сдружились. Предыдущий охранник посзвал Максима Сукова к себе в шк.";
