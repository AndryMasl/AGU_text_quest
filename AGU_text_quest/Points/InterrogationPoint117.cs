...
namespace Points
{
    ...
    {
        public override string Content => $"{Player.Name} толкает Белика в хату. Белик вместе с блохтной падают на пол и Белик выстреливает прям в висок Блохиной. Качок бросается на Белика и начинает душить его , что есть мочи в моевом пузыре) Белик весь синеет и говорит: 'Вы выиграли битву, но не выиграли войну' и стреляет в люстру наверху. Юнис все видет это:";
