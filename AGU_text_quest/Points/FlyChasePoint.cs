...
namespace Points
{
	...
	internal class FirstActionFlyChasePoint : FirstAction
	{
		...
		private void DoAfterActionLocal(Player player)
		{
			...
			{
				Console.WriteLine($"И вот блин, {player.Name} подпрыгнул всего на 1 метр, а птеродактиль на высоте в 100 метров. Эх блин, а ведь такая хорошая затея была.");
			}
		}
	}
}
